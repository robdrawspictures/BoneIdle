...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Enemy boss1 = new Enemy("Death", EnemyType.BOSS, 100, "Lord of the underworld, the original goth.");
        Enemy boss2 = new Enemy("Sadako", EnemyType.BOSS, 100, "Fell down a well, she'll send you to hell.");
        Enemy boss3 = new Enemy("Hollow", EnemyType.BOSS, 100, "An empty vessel, motivated by hate.");
        Enemy boss4 = new Enemy("Emil", EnemyType.BOSS, 100, "Number one best boy, no contest.");
        Enemy boss5 = new Enemy("Dio", EnemyType.BOSS, 100, "Kono Dio da, Za Warudo, how many breads, wryyyy etc.");
        Enemy enemy1 = new Enemy("Slime", EnemyType.MONSTER, 10, "Every game needs a slime.");
        Enemy enemy2 = new Enemy("Skeleton", EnemyType.MONSTER, 20, "Some say they used to be adventurers, themselves.");
        Enemy enemy3 = new Enemy("Doll", EnemyType.MONSTER, 30, "Every house needs one.");
        Enemy enemy4 = new Enemy("Mushaboom", EnemyType.MONSTER, 40, "Caught you mirin', brah.");
        Enemy enemy5 = new Enemy("Shambler", EnemyType.MONSTER, 50, "Not much of a conversationalist.");
        Enemy enemy6 = new Enemy("Tonberry", EnemyType.MONSTER, 60, "Don't get close, that knife's sharper than it looks.");
        Enemy enemy7 = new Enemy("Unborn", EnemyType.MONSTER, 70, "Searching for a mother, probably wise not to make eye contact.");
        Enemy enemy8 = new Enemy("Oni", EnemyType.MONSTER, 80, "Is that a face or a mask? It's all very philosophical.");
        Enemy enemy9 = new Enemy("Screamer", EnemyType.MONSTER, 50, "AHHHHHHHHHHHHHHHH.");
        Enemy enemy10 = new Enemy("Mimic", EnemyType.MONSTER, 90, "Some say it can be bargained with, but few would pay the price.");
